...
define(function() {
  return { 
    ...
    Hs : { radius : 0   ,color : "#E00038", ionic : { } },
    Mt : { radius : 0   ,color : "#E6002E", ionic : { } },
    Ds : { radius : 0   ,color : "#EB0026", ionic : { } },
    Rg : { radius : 0   ,color : "#FFFFF", ionic : { } },
    Cn : { radius : 0   ,color : "#FFFFF", ionic : { } },
    Uut: { radius : 0   ,color : "#FFFFF", ionic : { } },
    Fl : { radius : 0   ,color : "#FFFFF", ionic : { } },
    Uup: { radius : 0   ,color : "#FFFFF", ionic : { } },
    Lv : { radius : 0   ,color : "#FFFFF", ionic : { } },
    Uus: { radius : 0   ,color : "#FFFFF", ionic : { } },
    Uuo: { radius : 0   ,color : "#FFFFF", ionic : { } }
